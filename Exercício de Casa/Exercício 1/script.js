...
//  *OBS:* pense sobre a exibição dos dados. O que é mais válido ao usuário: dispor essas apenas essas 
// informações na tela, ou trazê-las de forma organizada?
...
function mapeandoLivros(objeto) {
  ...
  // 3. **Opcional:** Criar uma função que trate as datas salvas na chave `published`, trazendo no `console.log()` 
  // os valores contendo apenas as datas no formato `pt-br`.
